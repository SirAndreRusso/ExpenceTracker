...
extension Category {
    ...
    static let billsAndUtilitaries = Category(id: 2, name: "Bills & Utilitaries", icon: .file_invoice_dollar)
    ...
    static let foodAndDrinking = Category(id: 5, name: "Food & Drinking", icon: .hamburger)
